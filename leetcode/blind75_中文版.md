...
| --- | --- | --- | ------------------------------------------------------------------------------------------------------ | ----- | --------------- | --- | ---- | ----- | ----- | ------------------------- | ---- |
| 1   | [x] | 1   | [兩數之和 Two Sum](https://leetcode.com/problems/two-sum/)                                                 | 🟢 簡單 | 陣列, 雜湊表         | 待解  |      |       |       | 給定整數陣列，回傳相加等於目標值的兩個索引。    |      |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 43 | [ ] | 703 | [資料流中的第 K 大元素 Kth Largest Element in a Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/) | 🟢 簡單 | 樹, 設計, 二元搜尋樹, 堆積 | 待解 | | | | 設計在資料流中找第 k 大元素的類別。 | |
| 44 | [ ] | 295 | [資料流的中位數 Find Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream/) | 🔴 困難 | 雙指針, 設計, 排序, 堆積 | 待解 | | | | 用兩個堆積動態維護資料流的中位數。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 45 | [ ] | 78 | [子集 Subsets](https://leetcode.com/problems/subsets/) | 🟡 中等 | 陣列, 回溯法, 位元操作 | 待解 | | | | 回傳整數陣列所有可能的子集。 | |
| 46 | [ ] | 39 | [組合總和 Combination Sum](https://leetcode.com/problems/combination-sum/) | 🟡 中等 | 陣列, 回溯法 | 待解 | | | | 找出所有和為目標值的組合，數字可重複使用。 | |
| 47 | [ ] | 46 | [全排列 Permutations](https://leetcode.com/problems/permutations/) | 🟡 中等 | 陣列, 回溯法 | 待解 | | | | 回傳不重複整數陣列的所有全排列。 | |
| 48 | [ ] | 79 | [單詞搜尋 Word Search](https://leetcode.com/problems/word-search/) | 🟡 中等 | 陣列, 回溯法, 矩陣, DFS | 待解 | | | | 判斷單詞是否存在於網格中（上下左右相鄰）。 | |
| 49 | [ ] | 51 | [N 皇后 N-Queens](https://leetcode.com/problems/n-queens/) | 🔴 困難 | 陣列, 回溯法 | 待解 | | | | 在 n×n 棋盤上放置 n 個皇后使其互不攻擊。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 50 | [ ] | 200 | [島嶼數量 Number of Islands](https://leetcode.com/problems/number-of-islands/) | 🟡 中等 | 陣列, DFS, BFS, 聯集查找, 矩陣 | 待解 | | | | 計算二維網格中島嶼的數量。 | |
| 51 | [ ] | 133 | [克隆圖 Clone Graph](https://leetcode.com/problems/clone-graph/) | 🟡 中等 | 雜湊表, DFS, BFS, 圖論 | 待解 | | | | 深度複製一個無向連通圖。 | |
| 52 | [ ] | 417 | [太平洋大西洋水流問題 Pacific Atlantic Water Flow](https://leetcode.com/problems/pacific-atlantic-water-flow/) | 🟡 中等 | 陣列, DFS, BFS, 矩陣 | 待解 | | | | 找出水流能同時到達兩個海洋的格子。 | |
| 53 | [ ] | 207 | [課程表 Course Schedule](https://leetcode.com/problems/course-schedule/) | 🟡 中等 | DFS, BFS, 圖論, 拓撲排序 | 待解 | | | | 判斷給定先修關係下是否能完成所有課程。 | |
| 54 | [ ] | 323 | [無向圖中連通分量的數目 Number of Connected Components](https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/) | 🟡 中等 | DFS, BFS, 聯集查找, 圖論 | 待解 | | | | 計算無向圖中連通分量的數量。 | |
| 55 | [ ] | 261 | [以圖判樹 Graph Valid Tree](https://leetcode.com/problems/graph-valid-tree/) | 🟡 中等 | DFS, BFS, 聯集查找, 圖論 | 待解 | | | | 判斷 n 個節點與給定邊是否構成有效的樹。 | |
| 56 | [ ] | 127 | [單詞接龍 Word Ladder](https://leetcode.com/problems/word-ladder/) | 🔴 困難 | 雜湊表, 字串, BFS | 待解 | | | | 找從起始單詞到目標單詞的最短轉換序列長度。 | |

---

## 進階圖論 Advanced Graphs

| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 57 | [ ] | 269 | [火星字典 Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) | 🔴 困難 | 陣列, 字串, 圖論, 拓撲排序, BFS/DFS | 待解 | | | | 從排序好的外星語單詞推導字元順序。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 58 | [ ] | 70 | [爬樓梯 Climbing Stairs](https://leetcode.com/problems/climbing-stairs/) | 🟢 簡單 | 數學, 動態規劃, 記憶化搜尋 | 待解 | | | | 計算每次爬 1 或 2 階時爬到頂端的不同方法數。 | |
| 59 | [ ] | 198 | [打家劫舍 House Robber](https://leetcode.com/problems/house-robber/) | 🟡 中等 | 陣列, 動態規劃 | 待解 | | | | 不搶相鄰房屋的情況下最大化搶劫金額。 | |
| 60 | [ ] | 213 | [打家劫舍 II House Robber II](https://leetcode.com/problems/house-robber-ii/) | 🟡 中等 | 陣列, 動態規劃 | 待解 | | | | 打家劫舍的環形版本。 | |
| 61 | [ ] | 5 | [最長回文子串 Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | 🟡 中等 | 字串, 動態規劃 | 待解 | | | | 找出最長的回文子串。 | |
| 62 | [ ] | 647 | [回文子串 Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) | 🟡 中等 | 字串, 動態規劃 | 待解 | | | | 計算字串中有多少個回文子串。 | |
| 63 | [ ] | 91 | [解碼方法 Decode Ways](https://leetcode.com/problems/decode-ways/) | 🟡 中等 | 字串, 動態規劃 | 待解 | | | | 計算數字字串能解碼成字母的方法數。 | |
| 64 | [ ] | 322 | [零錢兌換 Coin Change](https://leetcode.com/problems/coin-change/) | 🟡 中等 | 陣列, 動態規劃, BFS | 待解 | | | | 找出湊成目標金額所需的最少硬幣數。 | |
| 65 | [ ] | 152 | [乘積最大子陣列 Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) | 🟡 中等 | 陣列, 動態規劃 | 待解 | | | | 找出乘積最大的連續子陣列。 | |
| 66 | [ ] | 139 | [單詞拆分 Word Break](https://leetcode.com/problems/word-break/) | 🟡 中等 | 雜湊表, 字串, 動態規劃, 字典樹 | 待解 | | | | 判斷字串是否能被拆分為字典中的單詞。 | |
| 67 | [ ] | 300 | [最長遞增子序列 Longest Increasing Subsequence](https://leetcode.com/problems/longest-increasing-subsequence/) | 🟡 中等 | 陣列, 二分搜尋, 動態規劃 | 待解 | | | | 找出最長嚴格遞增子序列的長度。 | |
| 68 | [ ] | 416 | [分割等和子集 Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/) | 🟡 中等 | 陣列, 動態規劃 | 待解 | | | | 判斷陣列是否能分割成兩個和相等的子集。 | |

---

## 二維動態規劃 2D Dynamic Programming

| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 69 | [ ] | 62 | [不同路徑 Unique Paths](https://leetcode.com/problems/unique-paths/) | 🟡 中等 | 數學, 動態規劃, 組合數學 | 待解 | | | | 計算從網格左上到右下的不同路徑數。 | |
| 70 | [ ] | 1143 | [最長公共子序列 Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/) | 🟡 中等 | 字串, 動態規劃 | 待解 | | | | 找出兩個字串的最長公共子序列長度。 | |
| 71 | [ ] | 72 | [編輯距離 Edit Distance](https://leetcode.com/problems/edit-distance/) | 🟡 中等 | 字串, 動態規劃 | 待解 | | | | 找出將一個單詞轉換成另一個的最少操作次數。 | |
| 72 | [ ] | 10 | [正規表示式匹配 Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/) | 🔴 困難 | 字串, 動態規劃, 遞迴 | 待解 | | | | 實作支援 '.' 和 '*' 的正規表示式匹配。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 73 | [ ] | 57 | [插入區間 Insert Interval](https://leetcode.com/problems/insert-interval/) | 🟡 中等 | 陣列 | 待解 | | | | 將新區間插入有序不重疊的區間列表中。 | |
| 74 | [ ] | 56 | [合併區間 Merge Intervals](https://leetcode.com/problems/merge-intervals/) | 🟡 中等 | 陣列, 排序 | 待解 | | | | 合併所有重疊的區間。 | |
| 75 | [ ] | 435 | [無重疊區間 Non-Overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) | 🟡 中等 | 陣列, 動態規劃, 貪心, 排序 | 待解 | | | | 找出最少需要移除幾個區間才能使剩餘區間不重疊。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 76 | [ ] | 208 | [實作字典樹 Implement Trie](https://leetcode.com/problems/implement-trie-prefix-tree/) | 🟡 中等 | 雜湊表, 字串, 設計, 字典樹 | 待解 | | | | 實作包含 insert、search、startsWith 的字典樹。 | |
| 77 | [ ] | 211 | [新增與搜尋單詞 Design Add and Search Words](https://leetcode.com/problems/design-add-and-search-words-data-structure/) | 🟡 中等 | 字串, DFS, 設計, 字典樹 | 待解 | | | | 設計支援 '.' 萬用字元搜尋的資料結構。 | |
| 78 | [ ] | 212 | [單詞搜尋 II Word Search II](https://leetcode.com/problems/word-search-ii/) | 🔴 困難 | 陣列, 字串, 回溯法, 字典樹, 矩陣 | 待解 | | | | 找出字典中所有存在於網格中的單詞。 | |
...
| # | ✅ | 題號 | 題目 | 難度 | 標籤 | 狀態 | 解題日期 | 時間複雜度 | 空間複雜度 | 題目描述 | 解題筆記 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 84 | [ ] | 48 | [旋轉圖像 Rotate Image](https://leetcode.com/problems/rotate-image/) | 🟡 中等 | 陣列, 數學, 矩陣 | 待解 | | | | 原地將 n×n 矩陣順時針旋轉 90 度。 | |
| 85 | [ ] | 54 | [螺旋矩陣 Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | 🟡 中等 | 陣列, 矩陣, 模擬 | 待解 | | | | 以螺旋順序回傳矩陣中的所有元素。 | |
| 86 | [ ] | 73 | [矩陣置零 Set Matrix Zeroes](https://leetcode.com/problems/set-matrix-zeroes/) | 🟡 中等 | 陣列, 雜湊表, 矩陣 | 待解 | | | | 若元素為 0，則將其所在行與列全部置零。 | |
