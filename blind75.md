...
- Fill in **Date Solved**, **Time/Space Complexity**, and **Notes** after solving
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 43 | [ ] | 703 | [Kth Largest Element in a Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/) | Easy | Tree, Design, Binary Search Tree, Heap | Todo | | | | Design a class to find the kth largest element in a stream. | |
| 44 | [ ] | 295 | [Find Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream/) | Hard | Two Pointers, Design, Sorting, Heap | Todo | | | | Find the median of a data stream using two heaps. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 45 | [ ] | 78 | [Subsets](https://leetcode.com/problems/subsets/) | Medium | Array, Backtracking, Bit Manipulation | Todo | | | | Return all possible subsets of an integer array. | |
| 46 | [ ] | 39 | [Combination Sum](https://leetcode.com/problems/combination-sum/) | Medium | Array, Backtracking | Todo | | | | Find all combinations that sum to target using unlimited reuse. | |
| 47 | [ ] | 46 | [Permutations](https://leetcode.com/problems/permutations/) | Medium | Array, Backtracking | Todo | | | | Return all possible permutations of a distinct integer array. | |
| 48 | [ ] | 79 | [Word Search](https://leetcode.com/problems/word-search/) | Medium | Array, Backtracking, Matrix, DFS | Todo | | | | Check if a word exists in a grid by moving adjacently. | |
| 49 | [ ] | 51 | [N-Queens](https://leetcode.com/problems/n-queens/) | Hard | Array, Backtracking | Todo | | | | Place n queens on an n×n board so no two attack each other. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 50 | [ ] | 200 | [Number of Islands](https://leetcode.com/problems/number-of-islands/) | Medium | Array, DFS, BFS, Union Find, Matrix | Todo | | | | Count the number of islands in a 2D grid. | |
| 51 | [ ] | 133 | [Clone Graph](https://leetcode.com/problems/clone-graph/) | Medium | Hash Table, DFS, BFS, Graph | Todo | | | | Deep copy a connected undirected graph. | |
| 52 | [ ] | 417 | [Pacific Atlantic Water Flow](https://leetcode.com/problems/pacific-atlantic-water-flow/) | Medium | Array, DFS, BFS, Matrix | Todo | | | | Find cells where water can flow to both Pacific and Atlantic oceans. | |
| 53 | [ ] | 207 | [Course Schedule](https://leetcode.com/problems/course-schedule/) | Medium | DFS, BFS, Graph, Topological Sort | Todo | | | | Determine if you can finish all courses given prerequisites. | |
| 54 | [ ] | 323 | [Number of Connected Components](https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/) | Medium | DFS, BFS, Union Find, Graph | Todo | | | | Count connected components in an undirected graph. | |
| 55 | [ ] | 261 | [Graph Valid Tree](https://leetcode.com/problems/graph-valid-tree/) | Medium | DFS, BFS, Union Find, Graph | Todo | | | | Check if n nodes and given edges form a valid tree. | |
| 56 | [ ] | 127 | [Word Ladder](https://leetcode.com/problems/word-ladder/) | Hard | Hash Table, String, BFS | Todo | | | | Find shortest transformation sequence from beginWord to endWord. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 57 | [ ] | 269 | [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) | Hard | Array, String, Graph, Topological Sort, BFS/DFS | Todo | | | | Derive the character order of an alien language from sorted words. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 58 | [ ] | 70 | [Climbing Stairs](https://leetcode.com/problems/climbing-stairs/) | Easy | Math, DP, Memoization | Todo | | | | Count distinct ways to climb to the top with 1 or 2 steps. | |
| 59 | [ ] | 198 | [House Robber](https://leetcode.com/problems/house-robber/) | Medium | Array, DP | Todo | | | | Maximize money robbed without alerting adjacent houses. | |
| 60 | [ ] | 213 | [House Robber II](https://leetcode.com/problems/house-robber-ii/) | Medium | Array, DP | Todo | | | | House Robber but houses are in a circle. | |
| 61 | [ ] | 5 | [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | Medium | String, DP | Todo | | | | Find the longest palindromic substring. | |
| 62 | [ ] | 647 | [Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) | Medium | String, DP | Todo | | | | Count how many substrings are palindromes. | |
| 63 | [ ] | 91 | [Decode Ways](https://leetcode.com/problems/decode-ways/) | Medium | String, DP | Todo | | | | Count ways to decode a digit string to letters. | |
| 64 | [ ] | 322 | [Coin Change](https://leetcode.com/problems/coin-change/) | Medium | Array, DP, BFS | Todo | | | | Find fewest coins to make up a given amount. | |
| 65 | [ ] | 152 | [Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) | Medium | Array, DP | Todo | | | | Find the contiguous subarray with the largest product. | |
| 66 | [ ] | 139 | [Word Break](https://leetcode.com/problems/word-break/) | Medium | Hash Table, String, DP, Trie | Todo | | | | Determine if string can be segmented into dictionary words. | |
| 67 | [ ] | 300 | [Longest Increasing Subsequence](https://leetcode.com/problems/longest-increasing-subsequence/) | Medium | Array, Binary Search, DP | Todo | | | | Find the length of the longest strictly increasing subsequence. | |
| 68 | [ ] | 416 | [Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/) | Medium | Array, DP | Todo | | | | Determine if array can be partitioned into two equal-sum subsets. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 69 | [ ] | 62 | [Unique Paths](https://leetcode.com/problems/unique-paths/) | Medium | Math, DP, Combinatorics | Todo | | | | Count unique paths from top-left to bottom-right of a grid. | |
| 70 | [ ] | 1143 | [Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/) | Medium | String, DP | Todo | | | | Find the length of the longest common subsequence of two strings. | |
| 71 | [ ] | 72 | [Edit Distance](https://leetcode.com/problems/edit-distance/) | Medium | String, DP | Todo | | | | Find minimum operations to convert one word to another. | |
| 72 | [ ] | 10 | [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/) | Hard | String, DP, Recursion | Todo | | | | Implement regex matching with '.' and '*'. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 73 | [ ] | 57 | [Insert Interval](https://leetcode.com/problems/insert-interval/) | Medium | Array | Todo | | | | Insert a new interval into a sorted non-overlapping interval list. | |
| 74 | [ ] | 56 | [Merge Intervals](https://leetcode.com/problems/merge-intervals/) | Medium | Array, Sorting | Todo | | | | Merge all overlapping intervals. | |
| 75 | [ ] | 435 | [Non-Overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) | Medium | Array, DP, Greedy, Sorting | Todo | | | | Find minimum intervals to remove to make rest non-overlapping. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 76 | [ ] | 208 | [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) | Medium | Hash Table, String, Design, Trie | Todo | | | | Implement insert, search, and startsWith for a Trie. | |
| 77 | [ ] | 211 | [Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/) | Medium | String, DFS, Design, Trie | Todo | | | | Design a data structure that supports adding and searching words with '.'. | |
| 78 | [ ] | 212 | [Word Search II](https://leetcode.com/problems/word-search-ii/) | Hard | Array, String, Backtracking, Trie, Matrix | Todo | | | | Find all words from dictionary that exist in a board. | |
...
| # | ✅ | Index | Title | Difficulty | Tag | Status | Date Solved | Time | Space | Description | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 84 | [ ] | 48 | [Rotate Image](https://leetcode.com/problems/rotate-image/) | Medium | Array, Math, Matrix | Todo | | | | Rotate an n×n matrix by 90 degrees in-place. | |
| 85 | [ ] | 54 | [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | Medium | Array, Matrix, Simulation | Todo | | | | Return all elements of a matrix in spiral order. | |
| 86 | [ ] | 73 | [Set Matrix Zeroes](https://leetcode.com/problems/set-matrix-zeroes/) | Medium | Array, Hash Table, Matrix | Todo | | | | Set entire row and column to 0 if an element is 0. | |
